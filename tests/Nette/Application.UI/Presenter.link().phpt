...
class TestPresenter extends Application\UI\Presenter
{
	...
	protected function startup()
	{
		...
		Assert::same( '/index.php?_sec=6e8ac795&action=default&do=pay&presenter=Test', $this->link('pay!', 'abc') );
		...
		Assert::same( '/index.php?mycontrol-_sec=97dc7d4e&action=default&do=mycontrol-pay&presenter=Test', $this->mycontrol->link('pay', 'abc') );
	 ...
	 * @secured
	 */
	public function handleList($sections)
	{
	}
